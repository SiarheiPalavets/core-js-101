...
function timeSpanToString(startDate, endDate) {
  ...
  const hours = Math.trunc((diffDate / 3600000) % 100).toString().padStart(2, '0');
  const minutes = Math.trunc((diffDate / 60000) % 60).toString().padStart(2, '0');
  const seconds = Math.trunc((diffDate / 1000) % 60).toString().padStart(2, '0');
  const mseconds = Math.trunc(diffDate % 1000).toString().padStart(3, '0');
